...
const generateReceiptForDownload = async (user) => {
  try {
    ...
    doc
      ...
      .fillColor(mediumGray)
      .font('Helvetica')
      .text('Contact: 9313720714 | Email: stargym0205@gmail.com', 0, contactY, { align: 'center' });
...
const generateAllMembersPDF = async (users) => {
  try {
    ...
    doc
      ...
      .text('For any queries, contact: stargym0205@gmail.com', 0, footerY + 23, { align: 'center' })
